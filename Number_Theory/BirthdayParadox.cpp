...
//What is the minimum no of people that should be present in a hall so that there's a 50(p) chance
//of two people having the same birthday


//if no of people = 2 chance that they dont have same birday = (365/365)*(364/365)=x
//then chance that they have sam bitday = 1-x
