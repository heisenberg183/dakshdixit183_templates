...
void solve(int n,vector<int> &arr,int k){
    vector<int> temp = countSmaller(arr);   //No of elements larget than the arr[i] to its right
    vector<int> arr2(arr.rbegin(),arr.rend());
    vector<int> temp2 = countSmaller(arr2); //No of elements smaller than the arr[i] to its left
