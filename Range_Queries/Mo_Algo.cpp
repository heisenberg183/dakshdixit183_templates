/*Daksh Dixit*/
//Priyansh Mo's Algo Also solves same problem without using struct
//Here I learnt Struct Initialisation,Operator Overloading,Coordinate Comperession as well;
